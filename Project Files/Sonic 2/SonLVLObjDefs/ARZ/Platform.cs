...
namespace S2ObjectDefinitions.ARZ
{
	...
	class VPlatform2 : ARZ.Platform
	{
		...
		{
			return new Sprite(LevelData.GetSpriteSheet("ARZ/Objects.gif").GetSection(191, 170, 64, 85), -32, -45);
		}
	}
	...
	abstract class Platform : ObjectDefinition
	{
		...
		{
			return new Sprite(LevelData.GetSpriteSheet("ARZ/Objects.gif").GetSection(126, 145, 64, 45), -32, -13);
		}
