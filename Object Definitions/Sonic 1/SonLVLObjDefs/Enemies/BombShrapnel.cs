		...
		public override void Init(ObjectData data)
		{
			switch (LevelData.StageInfo.folder)
			{
				...
				default:
					...
					break;
				case "Zone06":
					img = new Sprite(LevelData.GetSpriteSheet("SLZ/Objects.gif").GetSection(66, 79, 8, 8), -4, -4);
					break;
				case "Zone07":
					img = new Sprite(LevelData.GetSpriteSheet("SLZ/Objects.gif").GetSection(67, 367, 8, 8), -4, -4);
					break;
			}
		}
