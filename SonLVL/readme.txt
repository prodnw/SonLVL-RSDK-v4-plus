How to install: https://lavesiime.github.io/guides/sonlvl/install/

Controls:
Up, Down, Left, Right: Move the camera by 16 pixels.
Hold Shift: Move the camera by the size of a chunk (128 pixels).
...
Ctrl+5: Switch to Palette tab.
Ctrl+6: Switch to Settings tab.
...
S: Decrease PropertyValue of all selected objects.
X: Increase PropertyValue of all selected objects.
D: Decrease EntityPos of all selected objects.
...
Use the property grid on the right to edit properties for selected objects.
